-- Migration 047: GSC Search Analytics Dimensional Table
...
DROP INDEX IF EXISTS gsc_sa_date_idx;
DROP INDEX IF EXISTS gsc_sa_page_idx;
DROP INDEX IF EXISTS gsc_sa_query_idx;
DROP INDEX IF EXISTS gsc_sa_site_date_idx;
...
CREATE TABLE IF NOT EXISTS gsc_search_analytics (
  ...
  -- Composite unique constraint using dimensional attributes
  CONSTRAINT gsc_analytics_unique UNIQUE (
    user_token, site_url, search_type, data_state,
