...
import { ArrowRight, Menu, Search, Key, Clock, Zap, Shield, Network, Link2, FileText, Target, ChevronDown, X, Image as ImageIcon } from 'lucide-react';
...
// Legend item component with motion collapse
const LegendItem: React.FC<{ color: string; label: string; show: boolean }> = ({ color, label, show }) => (
  <AnimatePresence>
    {show && (
      <motion.div
        key={label}
      ...
      >
        ...
        <span className="text-sm text-[#6B7278]">{label}</span>
      </motion.div>
    )}
  </AnimatePresence>
);
                ...
                {active >= 2 && (
                  ...
                  >
                    ...
                    {showImageHighlights && (
                      ...
                      >
                        <img 
                          src="https://images.unsplash.com/photo-1608222351212-18fe0ec7b13b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMGFuYWx5dGljcyUyMGRhc2hib2FyZHxlbnwxfHx8fDE3NjEyNTAwMTF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-[#4E555C] overflow-x-hidden">
      ...
      <div className="relative z-50 w-full flex justify-between items-center px-6 md:px-12 lg:px-20 xl:px-32 py-6">
        <div className="flex items-center">
          <h1 className="text-2xl sm:text-3xl tracking-tight">
            <span className="text-[#4E555C]">SEOAgent</span>
          </h1>
        </div>
        <div className="flex items-center gap-8">
          <nav className="hidden md:flex items-center gap-6">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="flex items-center gap-1 text-[#6B7278] hover:text-[#6B35F5] transition-colors">
                Integrations
          ...
          <div className="flex items-center gap-3">
            ...
            <Button className="bg-[#6B35F5] hover:bg-[#582ED6] text-white">
              Create Account
            </Button>
          </div>
        </div>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center">
        {/* Hero Section */}
        <div className="text-center px-4 pt-8 md:pt-16 pb-8 max-w-6xl mx-auto w-full">
          <motion.div 
                ...
                <div key={setIndex} className="flex gap-6 shrink-0">
                  <div className="bg-white border border-gray-200 rounded-2xl p-6 w-[400px] shrink-0 shadow-sm hover:shadow-md transition-shadow">
                    <p className="text-[#4E555C] mb-4 italic">
                      "SEOAgent transformed our content strategy. We've seen a 300% increase in organic traffic in just 2 months."
                    </p>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#6B35F5] rounded-full flex items-center justify-center text-white">
                        TF
                      </div>
                      <div>
                        <p className="text-[#4E555C]">TechFlow SaaS</p>
                        <p className="text-sm text-[#6B7278]">B2B SaaS Platform</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white border border-gray-200 rounded-2xl p-6 w-[400px] shrink-0 shadow-sm hover:shadow-md transition-shadow">
                    <p className="text-[#4E555C] mb-4 italic">
                      "Finally, SEO content that doesn't sound like it was written by a robot. The quality is outstanding."
                    </p>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[#4E555C]">Michael Rodriguez</p>
                        <p className="text-sm text-[#6B7278]">SEO Freelancer</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white border border-gray-200 rounded-2xl p-6 w-[400px] shrink-0 shadow-sm hover:shadow-md transition-shadow">
                    <p className="text-[#4E555C] mb-4 italic">
                      "We've tried every SEO tool out there. SEOAgent is the only one that actually delivers on its promises."
                    </p>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-[#4E555C]">Bella's Cafe</p>
                        <p className="text-sm text-[#6B7278]">Local Coffee Shop Chain</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white border border-gray-200 rounded-2xl p-6 w-[400px] shrink-0 shadow-sm hover:shadow-md transition-shadow">
                    <p className="text-[#4E555C] mb-4 italic">
                      "The strategic interlinking and topic clusters are game-changers. Our domain authority has skyrocketed."
                    </p>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#6B35F5] rounded-full flex items-center justify-center text-white">
                        SF
                      ...
                      <div>
                        <p className="text-[#4E555C]">SaaSify</p>
                        <p className="text-sm text-[#6B7278]">Project Management SaaS</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            >
              {[...Array(3)].map((_, setIndex) => (
                <div key={setIndex} className="flex gap-6 shrink-0">
                  <div className="bg-white border border-gray-200 rounded-2xl p-6 w-[400px] shrink-0 shadow-sm hover:shadow-md transition-shadow">
                    <p className="text-[#4E555C] mb-4 italic">
                      "Set it and forget it. SEOAgent handles everything while we focus on building our product."
                    </p>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#3B82F6] rounded-full flex items-center justify-center text-white">
                        PR
                      ...
                      <div>
                        <p className="text-[#4E555C]">Peak Roofing</p>
                        <p className="text-sm text-[#6B7278]">Regional Home Services</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white border border-gray-200 rounded-2xl p-6 w-[400px] shrink-0 shadow-sm hover:shadow-md transition-shadow">
                    <p className="text-[#4E555C] mb-4 italic">
                      "The ROI is incredible. We're getting more qualified leads than ever before from organic search."
                    </p>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#10B981] rounded-full flex items-center justify-center text-white">
                        SK
                      ...
                      <div>
                        <p className="text-[#4E555C]">Sarah Kim</p>
                        <p className="text-sm text-[#6B7278]">Independent SEO Consultant</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white border border-gray-200 rounded-2xl p-6 w-[400px] shrink-0 shadow-sm hover:shadow-md transition-shadow">
                    <p className="text-[#4E555C] mb-4 italic">
                      "Best investment we've made. Our blog traffic has 5x'd and we're ranking for dozens of new keywords."
                    </p>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#6B35F5] rounded-full flex items-center justify-center text-white">
                        CS
                      ...
                      <div>
                        <p className="text-[#4E555C]">CloudScale</p>
                        <p className="text-sm text-[#6B7278]">Analytics SaaS Platform</p>
                      </div>
                    </div>
                  </div>
                  <div className="bg-white border border-gray-200 rounded-2xl p-6 w-[400px] shrink-0 shadow-sm hover:shadow-md transition-shadow">
                    <p className="text-[#4E555C] mb-4 italic">
                      "Unlike other tools, SEOAgent creates content that actually ranks. No fluff, just results."
                    </p>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#3B82F6] rounded-full flex items-center justify-center text-white">
                        GF
                      ...
                      <div>
                        <p className="text-[#4E555C]">Green Thumb Nursery</p>
                        <p className="text-sm text-[#6B7278]">Garden Center & Landscaping</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        >
          ...
          <div className="max-w-3xl mx-auto text-center mb-12">
            <p className="text-lg text-[#6B7278] mb-8">
              Businesses that adapt to the new SEO landscape will dominate organic search. 
              Those who don't will be left behind with unranked, low-quality content that 
        ...
        {/* Strategic SEO Features - Scroll Interaction */}
        <StrategicSeoScrollSnap />

        {/* For SEO Freelancers Section */}
        <motion.div 
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            >
              ...
              <Button className="w-full bg-white border-2 border-[#6B35F5] text-[#6B35F5] hover:bg-[#F3F6FF] py-6 rounded-lg">
                Get Started
              </Button>
            </motion.div>
            ...
            >
              ...
              <Button className="w-full bg-white text-[#6B35F5] hover:bg-white/90 py-6 rounded-lg shadow-lg">
                Get Started
              </Button>
            </motion.div>
        ...
        {/* FAQ Section */}
        <div className="w-full max-w-5xl mx-auto px-4 pt-12 pb-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl md:text-5xl mb-4 text-[#4E555C] tracking-tight">
