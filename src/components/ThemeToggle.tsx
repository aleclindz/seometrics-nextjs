...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      >
        {/* Light mode icon */}
        <svg className={`${darkMode ? 'hidden' : 'block'} fill-current text-gray-500/80 dark:text-gray-400/80`} width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Dark mode icon */}
        <svg className={`${darkMode ? 'block' : 'hidden'} fill-current text-gray-500/80 dark:text-gray-400/80`} width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
