...
export type ResourceType = 'article' | 'site';

export async function trackUsage(userToken: string, resourceType: ResourceType, siteId?: number) {
  try {
...
export async function getUserUsage(userToken: string) {
  try {
