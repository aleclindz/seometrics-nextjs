...
async function generateGSCIndexingIssues(userToken: string, siteUrl: string) {
  const testUrls = [
    '/blog/seo-guide',
    '/products/analytics',
    '/about-us',
...
async function generateMissingSitemaps(userToken: string, siteUrl: string) {
...
async function generateRobotsIssues(userToken: string, siteUrl: string) {
  const { data, error } = await supabase
...
async function generateSchemaMissing(userToken: string, siteUrl: string) {
...
async function generateMobileIssues(userToken: string, siteUrl: string) {
...
function getIndexStatusDescription(issueType: string): string {
