...
exports.SVSOptimizedContentGenerator = void 0;
const openai_1 = __importDefault(require("openai"));
class SVSOptimizedContentGenerator {
    openai;
    constructor(apiKey) {
        this.openai = new openai_1.default({ apiKey });
    }
    async generateSVSOptimizedArticle(request) {
        const { title, keywords, websiteDomain, targetTopic = title, industry, contentLength = 'medium', tone = 'professional', targetSVSScore = 85 } = request;
...
Always respond with JSON in this exact format:
{
  ...
  "svsRecommendations": ["recommendation 1", "recommendation 2", ...]
    ...
    buildSVSOptimizedPrompt(request) {
        const { title, keywords, websiteDomain, targetTopic, industry, contentLength, tone, targetSVSScore } = request;
        const wordTargets = {
            short: '800-1200',
            medium: '1500-2500',
            long: '3000-4500'
...
Return as JSON with all required fields. Make the content engaging, informative, and highly optimized for both users and AI search engines.`;
     ...
     */
    async analyzeSVSOpportunities(content, title, keywords) {
...
exports.SVSOptimizedContentGenerator = SVSOptimizedContentGenerator;
