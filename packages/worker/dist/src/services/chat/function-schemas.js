...
exports.FUNCTION_REGISTRY = exports.AuditSiteSchema = exports.GetSiteStatusSchema = exports.CreateIdeaSchema = exports.GenerateArticleSchema = exports.SyncGSCDataSchema = exports.ConnectGSCSchema = void 0;
exports.getFunctionSchemas = getFunctionSchemas;
exports.validateFunctionArgs = validateFunctionArgs;
exports.getAvailableToolsForSetup = getAvailableToolsForSetup;
...
const flexibleUrlSchema = zod_1.z.string().transform((val, ctx) => {
...
exports.ConnectGSCSchema = zod_1.z.object({
    site_url: flexibleUrlSchema
});
exports.SyncGSCDataSchema = zod_1.z.object({
    site_url: flexibleUrlSchema
});
exports.GenerateArticleSchema = zod_1.z.object({
    topic: zod_1.z.string().min(1, 'Topic is required'),
    target_keywords: zod_1.z.array(zod_1.z.string()).optional(),
    content_type: zod_1.z.enum(['blog_post', 'landing_page', 'guide']).default('blog_post'),
    word_count: zod_1.z.number().min(300).max(5000).default(1500),
...
exports.CreateIdeaSchema = zod_1.z.object({
    ...
    ice_score: zod_1.z.number().min(1).max(100).default(70)
});
exports.GetSiteStatusSchema = zod_1.z.object({
    site_url: flexibleUrlSchema
});
exports.AuditSiteSchema = zod_1.z.object({
    site_url: flexibleUrlSchema,
    include_gsc_data: zod_1.z.boolean().default(true),
    audit_type: zod_1.z.enum(['technical', 'content', 'performance', 'full']).default('full')
});
exports.FUNCTION_REGISTRY = {
    ...
    'GSC_sync_data': {
        ...
        validator: zod_1.z.object({
            site_url: flexibleUrlSchema,
            date_range: zod_1.z.string().optional().default('30d')
        }),
        category: 'analytics',
        requiresSetup: true
    },
    ...
    'KEYWORDS_get_strategy': {
        ...
        validator: zod_1.z.object({
            site_url: zod_1.z.string().optional()
        }),
        category: 'content',
        requiresSetup: false
    },
    'KEYWORDS_add_keywords': {
        ...
        validator: zod_1.z.object({
            ...
            keywords: zod_1.z.array(zod_1.z.object({
                ...
                keyword_type: zod_1.z.enum(['primary', 'secondary', 'long_tail']).optional().default('long_tail'),
                topic_cluster: zod_1.z.string().optional()
            }))
        }),
        category: 'content',
        requiresSetup: false
    ...
    'KEYWORDS_brainstorm': {
        ...
        validator: zod_1.z.object({
            site_url: zod_1.z.string().optional(),
            base_keywords: zod_1.z.array(zod_1.z.string()).optional().default([]),
            topic_focus: zod_1.z.string().optional(),
            generate_count: zod_1.z.number().int().optional().default(10),
            avoid_duplicates: zod_1.z.boolean().optional().default(true)
        }),
        category: 'content',
        requiresSetup: false
    },
    'KEYWORDS_brainstorm_auto': {
        ...
        validator: zod_1.z.object({
            site_url: zod_1.z.string().optional(),
            generate_count: zod_1.z.number().int().optional().default(15),
            avoid_duplicates: zod_1.z.boolean().optional().default(true)
        }),
        category: 'content',
        requiresSetup: false
    ...
    'CONTENT_optimize_existing': {
        ...
        validator: zod_1.z.object({
            ...
            target_keywords: zod_1.z.array(zod_1.z.string())
        }),
        category: 'content',
        requiresSetup: false
    },
    'SEO_apply_fixes': {
        ...
        validator: zod_1.z.object({
            site_url: flexibleUrlSchema,
            fix_types: zod_1.z.array(zod_1.z.string())
        }),
        category: 'seo',
        requiresSetup: false
    },
    'SEO_analyze_technical': {
        ...
        validator: zod_1.z.object({
            site_url: flexibleUrlSchema,
            check_mobile: zod_1.z.boolean().optional().default(true)
        }),
        category: 'seo',
        requiresSetup: false
    },
    'SEO_crawl_website': {
        ...
        validator: zod_1.z.object({
            site_url: flexibleUrlSchema,
            max_pages: zod_1.z.number().int().min(1).max(1000).optional().default(50),
            crawl_depth: zod_1.z.number().int().min(1).max(10).optional().default(3)
        }),
        category: 'seo',
        requiresSetup: false
    },
    ...
    'SITEMAP_generate_submit': {
        ...
        validator: zod_1.z.object({
            site_url: flexibleUrlSchema,
            submit_to_gsc: zod_1.z.boolean().optional().default(true)
        }),
        category: 'seo',
        requiresSetup: false
    },
    ...
    'VERIFY_check_changes': {
        ...
        validator: zod_1.z.object({
            ...
            expected_changes: zod_1.z.array(zod_1.z.string())
        }),
    ...
    'CONTENT_generate_article': {
        ...
        validator: zod_1.z.object({
            site_url: zod_1.z.string().optional(),
            specific_topic: zod_1.z.string().optional(),
            use_suggestion: zod_1.z.number().int().optional(),
            article_type: zod_1.z.enum(['how_to', 'listicle', 'guide', 'faq', 'comparison', 'evergreen', 'blog']).optional().default('blog'),
            tone: zod_1.z.enum(['professional', 'casual', 'technical']).optional().default('professional')
        }),
        category: 'content',
        requiresSetup: false
    },
    'CONTENT_generate_and_publish': {
        ...
        validator: zod_1.z.object({
            site_url: zod_1.z.string(),
            title: zod_1.z.string().min(5),
            target_keywords: zod_1.z.array(zod_1.z.string()).optional().default([]),
            article_type: zod_1.z.enum(['how_to', 'listicle', 'guide', 'faq', 'comparison', 'evergreen', 'blog']).optional().default('blog'),
            tone: zod_1.z.enum(['professional', 'casual', 'technical']).optional().default('professional'),
            publish: zod_1.z.boolean().optional().default(true),
            include_citations: zod_1.z.boolean().optional().default(true),
            image_provider: zod_1.z.enum(['openai', 'stability', 'unsplash']).optional().default('openai'),
            num_images: zod_1.z.number().int().optional().default(2)
        }),
        category: 'content',
        requiresSetup: false
    },
    'CONTENT_suggest_ideas': {
        ...
        validator: zod_1.z.object({
            site_url: zod_1.z.string().optional(),
            max_suggestions: zod_1.z.number().int().min(1).max(10).optional().default(5)
        }),
        category: 'content',
        requiresSetup: false
    },
    ...
    connect_gsc: {
        ...
        validator: exports.ConnectGSCSchema,
        category: 'setup',
        requiresSetup: false
    },
    sync_gsc_data: {
        ...
        validator: exports.SyncGSCDataSchema,
        category: 'monitoring',
        requiresSetup: true
    },
    generate_article: {
    ...
    create_idea: {
        ...
        validator: exports.CreateIdeaSchema,
    ...
    get_site_status: {
        ...
        validator: exports.GetSiteStatusSchema,
        category: 'monitoring',
        requiresSetup: false
    },
    audit_site: {
        ...
        validator: exports.AuditSiteSchema,
        category: 'monitoring',
        requiresSetup: true
    }
};
// Get schemas for OpenAI (optionally filtered)
function getFunctionSchemas(filter) {
    let functions = Object.entries(exports.FUNCTION_REGISTRY);
    if (filter) {
        if (filter.category) {
...
function validateFunctionArgs(functionName, args) {
    const definition = exports.FUNCTION_REGISTRY[functionName];
    if (!definition) {
...
function getAvailableToolsForSetup(setupStatus) {
