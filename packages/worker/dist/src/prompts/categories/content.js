...
exports.CONTENT_PROMPTS = void 0;
exports.registerContentPrompts = registerContentPrompts;
exports.CONTENT_PROMPTS = [
    {
 ...
 */
function registerContentPrompts(manager) {
    exports.CONTENT_PROMPTS.forEach(prompt => {
