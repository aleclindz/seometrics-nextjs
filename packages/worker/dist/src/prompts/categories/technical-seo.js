...
exports.TECHNICAL_SEO_PROMPTS = void 0;
exports.registerTechnicalSeoPrompts = registerTechnicalSeoPrompts;
exports.TECHNICAL_SEO_PROMPTS = [
    {
 ...
 */
function registerTechnicalSeoPrompts(manager) {
    exports.TECHNICAL_SEO_PROMPTS.forEach(prompt => {
