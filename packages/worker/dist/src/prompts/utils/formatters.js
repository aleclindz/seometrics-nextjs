...
exports.formatWebsiteContext = formatWebsiteContext;
exports.formatContentSpecs = formatContentSpecs;
exports.cleanPromptText = cleanPromptText;
exports.applyEnvironmentModifications = applyEnvironmentModifications;
/**
 ...
 */
function formatWebsiteContext(variables) {
    const parts = [];
 ...
 */
function formatContentSpecs(variables) {
    const specs = [];
 ...
 */
function applyEnvironmentModifications(prompt, environment = process.env.NODE_ENV || 'production') {
    let result = prompt;
