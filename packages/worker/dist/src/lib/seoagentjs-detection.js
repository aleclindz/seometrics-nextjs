...
exports.checkSmartJSInstallation = checkSmartJSInstallation;
exports.checkMultipleWebsites = checkMultipleWebsites;
 ...
 */
async function checkSmartJSInstallation(websiteUrl) {
    const result = {
        installed: false,
        active: false,
        scriptFound: false,
