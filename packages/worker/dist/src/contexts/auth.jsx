...
function AuthProvider({ children }) {
    ...
    const [sessionTimeout, setSessionTimeout] = (0, react_1.useState)(null);
    const supabase = (0, supabase_1.createClientComponentClient)();
    ...
    return (<AuthContext.Provider value={{ user, loading, signIn, signUp, signOut, validateSession, resendVerificationEmail }}>
      {children}
