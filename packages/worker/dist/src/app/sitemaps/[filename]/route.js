...
async function GET(request, { params }) {
    try {
        ...
        if (!domain) {
            ...
            return new server_1.NextResponse('Invalid sitemap filename', { status: 400 });
        }
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <url>
    ...
    <priority>0.7</priority>
            ...
            return new server_1.NextResponse(basicSitemapXML, {
                headers: {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (sitemapData.success && sitemapData.data.sitemapXML) {
                        ...
                        return new server_1.NextResponse(sitemapData.data.sitemapXML, {
                            headers: {
                                'Content-Type': 'application/xml',
                                'Cache-Control': 'public, max-age=3600',
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    ...
    <priority>1.0</priority>
            ...
            return new server_1.NextResponse(fallbackSitemapXML, {
                headers: {
                    'Content-Type': 'application/xml',
        ...
        if (sitemapRecord.sitemap_content) {
            return new server_1.NextResponse(sitemapRecord.sitemap_content, {
                headers: {
                    'Content-Type': 'application/xml',
                    'Cache-Control': 'public, max-age=3600',
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    ...
    <priority>1.0</priority>
        ...
        return new server_1.NextResponse(reconstructedSitemapXML, {
            headers: {
                'Content-Type': 'application/xml',
                'Cache-Control': 'public, max-age=1800',
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    ...
    <priority>1.0</priority>
        ...
        return new server_1.NextResponse(errorSitemapXML, {
            status: 500,
            headers: {
                'Content-Type': 'application/xml',
