...
# ${new Date().toISOString()}`;
        ...
        return server_1.NextResponse.json({ error: 'Internal server error serving robots.txt' }, { status: 500 });
    }
}
...
async function POST(request) {
    try {
        ...
        if (error) {
            ...
            return server_1.NextResponse.json({ error: 'Failed to store robots.txt content' }, { status: 500 });
        }
        ...
        return server_1.NextResponse.json({ error: 'Internal server error storing robots.txt' }, { status: 500 });
    }
}
