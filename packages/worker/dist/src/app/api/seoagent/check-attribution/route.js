...
async function GET(request) {
    try {
        ...
        if (websiteError || !website) {
            ...
            return server_1.NextResponse.json({ requireAttribution: true }, // Default to requiring attribution for security
            { status: 200 });
        }
        ...
        if (planError || !userPlan) {
            ...
            if (loginError || !loginUser) {
                ...
                return server_1.NextResponse.json({ requireAttribution: true });
            }
            ...
            return server_1.NextResponse.json({ requireAttribution });
        }
        ...
        return server_1.NextResponse.json({ requireAttribution: true }, // Default to requiring attribution on error
        { status: 200 });
    }
}
