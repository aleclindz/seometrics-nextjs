...
async function GET(request) {
    try {
        ...
        if (!authUserId) {
            return server_1.NextResponse.json({ error: 'Missing authUserId parameter' }, { status: 400 });
        }
        ...
        if (error) {
            ...
            return server_1.NextResponse.json({ error: 'User not found', details: error }, { status: 404 });
        }
