...
async function POST(request) {
    try {
        ...
        const { userToken, websiteToken, siteUrl, pageUrls, targetTopic, industry, analysisType = 'page', maxConcurrent = 3 } = body;
 ...
 */
async function analyzeSinglePage({ userToken, websiteToken, siteUrl, pageUrl, targetTopic, industry, analysisType, analyzer }) {
    try {
        // Validate URL format
